...
Ingame_Stage4_Scene::Ingame_Stage4_Scene(SaveManager* aSaveManager)
...
void Ingame_Stage4_Scene::LoadTileSets()
{
    // BMP_BG_STG01
    // TODO: Choose tile meta based on level number (this->saveManager->nextLevel)
    this->stageBackgroundTileSetEntity = new TileSetEntity(this, this->sceneBitmapMgr->bitmapPtrs[38], &Ingame_Stage4_Scene_Meta::StageBackgroundEntity_TileMeta);
}
...
const TileMeta Ingame_Stage4_Scene_Meta::StageBackgroundEntity_TileMeta =
{
    640,
    480,
    16,
