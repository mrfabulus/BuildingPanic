...
Ingame_Stage2_Scene::Ingame_Stage2_Scene(SaveManager* aSaveManager)
...
Ingame_Stage2_Scene::~Ingame_Stage2_Scene()
{
}

void Ingame_Stage2_Scene::LoadTileSets()
{
    // BMP_BG_STG01
    // TODO: Choose tile meta based on level number (this->saveManager->nextLevel)
    this->stageBackgroundTileSetEntity = new TileSetEntity(this, this->sceneBitmapMgr->bitmapPtrs[38], &Ingame_Stage2_Scene_Meta::StageBackgroundEntity_TileMeta);
}
...
const TileMeta Ingame_Stage2_Scene_Meta::StageBackgroundEntity_TileMeta =
{
    640,
    480,
    16,
