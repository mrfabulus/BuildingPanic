...
Ingame_Stage5_Scene::Ingame_Stage5_Scene(SaveManager* aSaveManager)
...
Ingame_Stage5_Scene::~Ingame_Stage5_Scene()
{
}

void Ingame_Stage5_Scene::LoadTileSets()
{
    // BMP_BG_STG01
    // TODO: Choose tile meta based on level number (this->saveManager->nextLevel)
    this->stageBackgroundTileSetEntity = new TileSetEntity(this, this->sceneBitmapMgr->bitmapPtrs[38], &Ingame_Stage5_Scene_Meta::StageBackgroundEntity_TileMeta);
}
...
const TileMeta Ingame_Stage5_Scene_Meta::StageBackgroundEntity_TileMeta =
{
    640,
    480,
    16,
